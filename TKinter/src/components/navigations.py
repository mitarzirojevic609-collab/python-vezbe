...
from TKinter.src.windows.users import show_users_window
from TKinter.src.windows.payments import show_payment_window
...
def show_navigation(window):
    nav_item = ["Uplate", "Korisnici", "Dodavanje uplata", "Dodavanje korisnika"]
